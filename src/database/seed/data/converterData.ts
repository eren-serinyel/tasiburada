...
export const CONVERTER_ITEM_CATALOG_V1: ConverterCatalogSeedItem[] = [
  ...
  { itemCode: 'wardrobe_3door', label: '3 kapili dolap', category: 'bedroom', unitVolumeMin: 1.6, unitVolumeMax: 2.2, isSpecial: false, isActive: true, sortOrder: 120 },
  { itemCode: 'dresser', label: 'Sifonyer/cekmece dolabi', category: 'bedroom', unitVolumeMin: 0.6, unitVolumeMax: 1.0, isSpecial: false, isActive: true, sortOrder: 130 },
  ...
  { itemCode: 'fridge_large', label: 'Buyuk buzdolabi', category: 'appliance', unitVolumeMin: 0.9, unitVolumeMax: 1.3, isSpecial: false, isActive: true, sortOrder: 220 },
  { itemCode: 'fridge_small', label: 'Kucuk buzdolabi', category: 'appliance', unitVolumeMin: 0.5, unitVolumeMax: 0.8, isSpecial: false, isActive: true, sortOrder: 230 },
  ...
  { itemCode: 'box_small', label: 'Kucuk koli', category: 'box', unitVolumeMin: 0.04, unitVolumeMax: 0.06, isSpecial: false, isActive: true, sortOrder: 300 },
  { itemCode: 'box_medium', label: 'Orta koli', category: 'box', unitVolumeMin: 0.08, unitVolumeMax: 0.12, isSpecial: false, isActive: true, sortOrder: 310 },
  { itemCode: 'box_large', label: 'Buyuk koli', category: 'box', unitVolumeMin: 0.14, unitVolumeMax: 0.2, isSpecial: false, isActive: true, sortOrder: 320 },
  ...
  { itemCode: 'safe_box', label: 'Kasa', category: 'special', unitVolumeMin: 0.4, unitVolumeMax: 0.9, isSpecial: true, isActive: true, sortOrder: 420 },
];
