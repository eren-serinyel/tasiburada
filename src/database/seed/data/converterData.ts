...
export const CONVERTER_ITEM_CATALOG_V1: ConverterCatalogSeedItem[] = [
  ...
  { itemCode: 'tv_unit_large', label: 'TV unitesi (buyuk)', category: 'living_room', unitVolumeMin: 0.6, unitVolumeMax: 0.9, isSpecial: false, isActive: true, sortOrder: 70 },
  ...
  { itemCode: 'display_cabinet', label: 'Vitrin / Camli dolap', category: 'living_room', unitVolumeMin: 0.9, unitVolumeMax: 1.4, isSpecial: false, isActive: true, sortOrder: 90 },
  { itemCode: 'bookshelf', label: 'Kutuphane / Kitaplik', category: 'living_room', unitVolumeMin: 0.7, unitVolumeMax: 1.2, isSpecial: false, isActive: true, sortOrder: 95 },
  ...
  { itemCode: 'wardrobe_2door', label: 'Gardrop (2 kanatli)', category: 'bedroom', unitVolumeMin: 1.4, unitVolumeMax: 1.9, isSpecial: false, isActive: true, sortOrder: 125 },
  { itemCode: 'wardrobe_3door', label: 'Gardrop (3-4 kanatli)', category: 'bedroom', unitVolumeMin: 2.0, unitVolumeMax: 2.8, isSpecial: false, isActive: true, sortOrder: 130 },
  { itemCode: 'dresser', label: 'Sifonyer', category: 'bedroom', unitVolumeMin: 0.5, unitVolumeMax: 0.8, isSpecial: false, isActive: true, sortOrder: 135 },
  ...
  { itemCode: 'vanity', label: 'Makyaj masasi', category: 'bedroom', unitVolumeMin: 0.4, unitVolumeMax: 0.6, isSpecial: false, isActive: true, sortOrder: 145 },
  ...
  { itemCode: 'microwave', label: 'Mikrodalga firin', category: 'appliance', unitVolumeMin: 0.05, unitVolumeMax: 0.1, isSpecial: false, isActive: true, sortOrder: 260 },
  { itemCode: 'dryer', label: 'Camasir kurutucu', category: 'appliance', unitVolumeMin: 0.4, unitVolumeMax: 0.55, isSpecial: false, isActive: true, sortOrder: 270 },
  ...
  { itemCode: 'treadmill', label: 'Kosu bandi', category: 'special', unitVolumeMin: 0.6, unitVolumeMax: 1.0, isSpecial: true, isActive: true, sortOrder: 430 },
  ...
  { itemCode: 'safe', label: 'Celik kasa / Para kasasi', category: 'special', unitVolumeMin: 0.2, unitVolumeMax: 0.6, isSpecial: true, isActive: true, sortOrder: 450 },
];
