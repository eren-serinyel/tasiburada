...
export class FreshStart1774177263756 implements MigrationInterface {
    name = 'FreshStart1774177263756'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`carrier_documents\` (\`id\` varchar(36) NOT NULL, \`carrierId\` varchar(36) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NOT NULL, \`type\` varchar(120) NOT NULL, \`fileUrl\` varchar(500) NOT NULL, \`isRequired\` tinyint NOT NULL DEFAULT 1, \`status\` varchar(32) NOT NULL DEFAULT 'PENDING', \`isApproved\` tinyint NOT NULL DEFAULT 0, \`uploadedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`verifiedAt\` datetime NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`carrier_earnings\` (\`id\` varchar(36) NOT NULL, \`carrierId\` varchar(36) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NOT NULL, \`bankName\` varchar(255) NOT NULL, \`iban\` varchar(34) NOT NULL, \`accountHolder\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_cf5b6eaa7ff9e421934fde2c9c\` (\`carrierId\`), UNIQUE INDEX \`REL_cf5b6eaa7ff9e421934fde2c9c\` (\`carrierId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`carrier_vehicle_types\` (\`id\` varchar(36) NOT NULL, \`carrierId\` varchar(36) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NOT NULL, \`vehicleTypeId\` varchar(255) NOT NULL, \`capacityKg\` decimal(10,2) NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_fcd807c2757b9d86fefb11b650\` (\`carrierId\`, \`vehicleTypeId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`carrier_profile_status\` (\`id\` varchar(36) NOT NULL, \`carrierId\` varchar(36) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NOT NULL, \`companyInfoCompleted\` tinyint NOT NULL DEFAULT 0, \`activityInfoCompleted\` tinyint NOT NULL DEFAULT 0, \`vehiclesCompleted\` tinyint NOT NULL DEFAULT 0, \`documentsCompleted\` tinyint NOT NULL DEFAULT 0, \`earningsCompleted\` tinyint NOT NULL DEFAULT 0, \`securityCompleted\` tinyint NOT NULL DEFAULT 0, \`notificationsCompleted\` tinyint NOT NULL DEFAULT 0, \`overallPercentage\` int NOT NULL DEFAULT '0', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_d1b4d44f60dd9d0ca4495f7fcb\` (\`carrierId\`), UNIQUE INDEX \`REL_d1b4d44f60dd9d0ca4495f7fcb\` (\`carrierId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`carrier_activity\` (\`id\` varchar(36) NOT NULL, \`carrierId\` varchar(36) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NOT NULL, \`city\` varchar(120) NOT NULL, \`district\` varchar(120) NULL, \`address\` text NULL, \`serviceAreasJson\` json NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_5c86c511608cc6846f28616c42\` (\`carrierId\`), UNIQUE INDEX \`REL_5c86c511608cc6846f28616c42\` (\`carrierId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`carrier_security_settings\` (\`id\` varchar(36) NOT NULL, \`carrierId\` varchar(36) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NOT NULL, \`twoFactorEnabled\` tinyint NOT NULL DEFAULT 0, \`suspiciousLoginAlertsEnabled\` tinyint NOT NULL DEFAULT 1, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_a09ffa9364ac74287f490fcb3b\` (\`carrierId\`), UNIQUE INDEX \`REL_a09ffa9364ac74287f490fcb3b\` (\`carrierId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`service_types\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(100) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_7dadebaed69653520aa93bbc84\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`carrier_service_types\` (\`id\` varchar(36) NOT NULL, \`carrierId\` varchar(36) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NOT NULL, \`serviceTypeId\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_914ce11550d7438ebbc321de48\` (\`carrierId\`, \`serviceTypeId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`scope_of_work\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(100) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_1bc181d5c5a4756d62f6922d5e\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`carrier_scope_of_work\` (\`id\` varchar(36) NOT NULL, \`carrierId\` varchar(36) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NOT NULL, \`scopeId\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_17df7ea5d551156bac841f09a2\` (\`carrierId\`, \`scopeId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`vehicle_types\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(100) NOT NULL, \`defaultCapacityKg\` int NOT NULL, \`defaultCapacityM3\` int NOT NULL, UNIQUE INDEX \`IDX_521e89eb074cfce4a101397064\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`shipments\` (\`id\` varchar(36) NOT NULL, \`customerId\` varchar(255) NOT NULL, \`carrierId\` varchar(36) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NULL, \`status\` enum ('pending', 'offer_received', 'matched', 'in_transit', 'completed', 'cancelled') NOT NULL DEFAULT 'pending', \`price\` decimal(10,2) NULL, \`origin\` varchar(255) NOT NULL, \`destination\` varchar(255) NOT NULL, \`loadDetails\` varchar(255) NOT NULL, \`weight\` decimal(10,2) NULL, \`shipmentDate\` date NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`reviews\` (\`id\` varchar(36) NOT NULL, \`shipmentId\` varchar(255) NOT NULL, \`carrierId\` varchar(36) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NOT NULL, \`customerId\` varchar(255) NOT NULL, \`rating\` int NOT NULL, \`comment\` text NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`carrier_stats\` (\`id\` varchar(36) NOT NULL, \`carrierId\` varchar(36) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NOT NULL, \`totalEarnings\` decimal(10,2) NOT NULL DEFAULT '0.00', \`totalJobs\` int NOT NULL DEFAULT '0', \`activeJobs\` int NOT NULL DEFAULT '0', \`averageRating\` decimal(3,2) NOT NULL DEFAULT '0.00', \`totalReviews\` int NOT NULL DEFAULT '0', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`REL_86ad2cb4e9a731ecc21d8d6992\` (\`carrierId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`carrier_earnings_log\` (\`id\` varchar(36) NOT NULL, \`carrierId\` varchar(36) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NOT NULL, \`shipmentId\` varchar(255) NOT NULL, \`amount\` decimal(10,2) NOT NULL, \`earnedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_521e89eb074cfce4a101397064\` ON \`vehicle_types\``);
        ...
        await queryRunner.query(`DROP TABLE \`carrier_scope_of_work\``);
        await queryRunner.query(`DROP INDEX \`IDX_1bc181d5c5a4756d62f6922d5e\` ON \`scope_of_work\``);
        await queryRunner.query(`DROP TABLE \`scope_of_work\``);
        await queryRunner.query(`DROP INDEX \`IDX_914ce11550d7438ebbc321de48\` ON \`carrier_service_types\``);
        await queryRunner.query(`DROP TABLE \`carrier_service_types\``);
        await queryRunner.query(`DROP INDEX \`IDX_7dadebaed69653520aa93bbc84\` ON \`service_types\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_a09ffa9364ac74287f490fcb3b\` ON \`carrier_security_settings\``);
        await queryRunner.query(`DROP TABLE \`carrier_security_settings\``);
        await queryRunner.query(`DROP INDEX \`REL_5c86c511608cc6846f28616c42\` ON \`carrier_activity\``);
        await queryRunner.query(`DROP INDEX \`IDX_5c86c511608cc6846f28616c42\` ON \`carrier_activity\``);
        await queryRunner.query(`DROP TABLE \`carrier_activity\``);
        await queryRunner.query(`DROP INDEX \`REL_d1b4d44f60dd9d0ca4495f7fcb\` ON \`carrier_profile_status\``);
        await queryRunner.query(`DROP INDEX \`IDX_d1b4d44f60dd9d0ca4495f7fcb\` ON \`carrier_profile_status\``);
        await queryRunner.query(`DROP TABLE \`carrier_profile_status\``);
        await queryRunner.query(`DROP INDEX \`IDX_fcd807c2757b9d86fefb11b650\` ON \`carrier_vehicle_types\``);
        await queryRunner.query(`DROP TABLE \`carrier_vehicle_types\``);
        await queryRunner.query(`DROP INDEX \`REL_cf5b6eaa7ff9e421934fde2c9c\` ON \`carrier_earnings\``);
        await queryRunner.query(`DROP INDEX \`IDX_cf5b6eaa7ff9e421934fde2c9c\` ON \`carrier_earnings\``);
        await queryRunner.query(`DROP TABLE \`carrier_earnings\``);
