      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-16">
        ...
        <div className="relative text-center pt-8 sm:pt-10">
          ...
          <div className="absolute -top-5 sm:-top-6 left-1/2 -translate-x-1/2 z-10 inline-flex items-center gap-2 rounded-full bg-white/70 backdrop-blur-md px-3.5 py-1.5 ring-1 ring-blue-200/60 shadow-sm">
            ...
            <span className="text-[11px] sm:text-xs font-medium text-blue-700/90">Çerez Kullanımı</span>
          </div>
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mt-4">
            Hangi amaçlarla çerez kullandığımız ve bu tercihleri nasıl yönetebileceğinizle ilgili özet bilgiler.
          </p>
        </div>
        ...
        <Card className="mt-8 rounded-xl shadow-xl border border-blue-100/60 backdrop-blur-md bg-white/80">
          <CardContent className="p-6 sm:p-10">
            <h2 className="text-xl font-semibold text-blue-700 mt-2 mb-3">Çerez Türleri ve Amaçları</h2>
            <ul className="mt-2 space-y-2">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 h-2 w-2 rounded-full bg-blue-400" />
                <span className="text-gray-700 text-sm sm:text-base"><span className="font-medium">Zorunlu:</span> Oturum açma durumunuzu hatırlamak, güvenlik ve temel işlevler için kullanılan çerezler.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 h-2 w-2 rounded-full bg-blue-400" />
                <span className="text-gray-700 text-sm sm:text-base"><span className="font-medium">Analiz:</span> Kullanım deneyimini geliştirmek için anonim istatistikler üreten çerezler.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 h-2 w-2 rounded-full bg-blue-400" />
                <span className="text-gray-700 text-sm sm:text-base"><span className="font-medium">Pazarlama:</span> Tercihleriniz doğrultusunda kampanya ve öneriler sunmak için izinli çerezler.</span>
              </li>
            </ul>

            <h2 className="text-xl font-semibold text-blue-700 mt-8 mb-3">Çerez Tercihleri</h2>
            <p className="text-gray-700 leading-relaxed">
              Tarayıcınızın ayarlarından çerezleri yönetebilir, silebilir veya engelleyebilirsiniz. Zorunlu çerezler
              kapatıldığında bazı özellikler düzgün çalışmayabilir. Çerez tercihleri araçlarımızla seçimlerinizi
              dilediğiniz an güncelleyebilirsiniz.
            </p>
